...
public class RenderedImageTypeAdapter extends TypeAdapter<RenderedImage> {
    ...
    public static TypeAdapter<RenderedImage> getRenderedImageTypeAdapter() {
        return renderedImageTypeAdapter;
    }

    @Override
    public void write(final JsonWriter out, final RenderedImage image) throws IOException {
        // Intermediate buffer
    ...
    @Override
    public RenderedImage read(final JsonReader in) throws IOException {
